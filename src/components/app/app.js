...
export default class App extends Component {
    constructor(props){
        ...
        this.state = {
            data : [
                {label: 'Going to learn React', like: false,Heart:false, id:1},
                {label: 'This is so good', like: false,Heart:false, id:2},
                {label: 'I need a break..', like: false,Heart:false, id :3}
            ],
            term: '',
            filter: 'all'
        };
